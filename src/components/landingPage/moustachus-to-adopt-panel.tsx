...
export async function MoustachusToAdoptPanel() {
  ...
  return (
    <section className="relative z-40 flex p-5 md:p-28 pt-12 gap-12 bg-primary-50 w-full">
      <div className="flex flex-col gap-6 w-full">
        ...
        <section className="flex p-8 pt-8 flex-wrap lg:justify-between gap-15 justify-center lg-gap-0">
          {animals.map((animal) => (
